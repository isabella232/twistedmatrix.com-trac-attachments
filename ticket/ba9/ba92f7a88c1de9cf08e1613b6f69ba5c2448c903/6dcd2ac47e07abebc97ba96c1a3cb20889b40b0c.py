...
class EchoProtocol(protocol.Protocol):
    ...
    def start(self):
        self.i = 0
        self.lc = LoopingCall(self.funkymonkey)
        self.lc.start(0.1)
        
    def funkymonkey(self):
        data = "no.%i" % self.i
        print "   >>> O",data
...
class SSHPP(protocol.ProcessProtocol):
...
if __name__ == '__main__':
    ...
    reactor.spawnProcess(SSHPP(10), "ssh", ["ssh","-t",'-o','RekeyLimit 2K','-o','CheckHostIP no',"user@localhost","-p","2222"],{},usePTY=1)
    reactor.run()
