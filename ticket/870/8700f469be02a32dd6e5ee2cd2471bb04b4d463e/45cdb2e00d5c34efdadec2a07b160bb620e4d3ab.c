/* Generated by Cython 0.9.6.8 on Wed Apr 09 11:06:09 2008 */
...
static char __pyx_k2[] = "This function is intentionally broken";

static PyObject *__pyx_pf_6raiser_raiseException(PyObject *__pyx_self, PyObject *unused); /*proto*/
static PyObject *__pyx_pf_6raiser_raiseException(PyObject *__pyx_self, PyObject *unused) {
  PyObject *__pyx_r;
  PyObject *__pyx_1 = 0;
  PyObject *__pyx_2 = 0;
  PyObject *__pyx_3 = 0;
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_n_RaiserException); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; goto __pyx_L1;}
  ...
  __pyx_3 = PyObject_CallObject(__pyx_1, __pyx_2); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; goto __pyx_L1;}
...
static struct PyMethodDef __pyx_methods[] = {
  {"raiseException", (PyCFunction)__pyx_pf_6raiser_raiseException, METH_NOARGS, 0},
  {0, 0, 0, 0}
};
...
PyMODINIT_FUNC initraiser(void) {
  ...
  /*--- Builtin init code ---*/
  __pyx_builtin_Exception = __Pyx_GetName(__pyx_b, __pyx_n_Exception); if (!__pyx_builtin_Exception) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; goto __pyx_L1;}
  /*--- Global init code ---*/
 ...
 * 
 */
  __pyx_1 = PyDict_New(); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; goto __pyx_L1;}
  __pyx_2 = PyTuple_New(1); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; goto __pyx_L1;}
  Py_INCREF(__pyx_builtin_Exception);
  PyTuple_SET_ITEM(__pyx_2, 0, __pyx_builtin_Exception);
  __pyx_3 = __Pyx_CreateClass(__pyx_2, __pyx_1, __pyx_n_RaiserException, "raiser"); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  if (PyObject_SetAttr(__pyx_m, __pyx_n_RaiserException, __pyx_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_1); __pyx_1 = 0;

  /* "C:\raiser\raiser.pyx":9
 *     pass
 * 
 * def raiseException():             # <<<<<<<<<<<<<< 
...
static PyObject* cleanup(PyObject *self, PyObject *unused) {
  ...
  /*--- Intern cleanup code ---*/
  Py_DECREF(__pyx_n_RaiserException); __pyx_n_RaiserException = 0;
