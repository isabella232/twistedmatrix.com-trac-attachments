...
from twisted.conch.ssh import session, forwarding, channel, transport, userauth
...
import os, sys, getpass, struct, base64, signal, stat, errno
#import tty, fncl
...
class SSHUserAuthClient(userauth.SSHUserAuthClient):
    ...
    def getPassword(self, prompt = None):
        ...
        return defer.succeed(getpass.getpass(prompt) )
...
#                return deferredAskFrame(prompt, 0).addCallback(self._cbGetPrivateKey, 0)
                return self.getPassword(prompt)
