...
member variable before calling reactor.run

reactor continues to process events normall
...
class MyFrame(wx.Frame):
    def __init__(self, parent, ID, title):
        ...
        self.dialog = wx.FileDialog(self, 'sdf', style = wx.OPEN)
    ...
    def DoOpen(self, event):
        ...
        self.dialog.Hide() # don't destroy, just hide
